...
# Online Shop in Node.js
> **Note:** This repository contains the core code of an Online shop using Node.js
...
## About The Project
Online shopping is a form of electronic commerce which allows consumers to directly buy goods or services from a seller over the Internet using a web browser. In this project i have developed an Online Shop (Using different database MySQL, MongoDB). For more clear idea, Check the branches.
...
1. Clone the repo
```sh
https://github.com/Masud99Rana/Online-Shop-in-Node.js.git
```
2. Run **npm install**
